...
namespace Infrastructure.ObjectModel
{
        ...
        where ComponentType : IGameComponent
    {
        ...
        protected List<Component2D> m_Components2D = new List<Component2D>();
        ...
        protected virtual void OnComponentRemoved(GameComponentEventArgs<ComponentType> e)
        {
            ...
            Component2D component = e.GameComponent as Component2D;
            if (component != null)
            {
                m_Components2D.Remove(component);
                component.DrawOrderChanged -= childDrawOrderChanged;
            }
        ...
        private void childDrawOrderChanged(object sender, EventArgs e)
        {
            ...
            if (component2D != null)
            {
                m_Components2D.Remove(component2D);
            }
            else
            {
                m_DrawableComponents.Remove(drawable);
        ...
        private void insertSorted(IDrawable i_Drawable)
        {
            ...
            if (component2D != null)
            {
                int idx = m_Components2D.BinarySearch(component2D, DrawableComparer<Component2D>.Default);
                if (idx < 0)
                {
                    idx = ~idx;
                }
                m_Components2D.Insert(idx, component2D);
            }
            else
            {
        ...
        protected override void LoadContent()
        {
            ...
            foreach (Component2D component in m_Components2D)
            {
        ...
        public Vector2 CenterOfViewPort
        {
            get
            {
